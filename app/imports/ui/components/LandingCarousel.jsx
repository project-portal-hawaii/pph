  ...
  return (
    <div className="carousel-text">
      <Carousel activeIndex={index} onSelect={handleSelect}>
        <Carousel.Item>
          <Image src="/images/sign-up.png" fluid style={{ border: '5px solid black' }} />
          <Carousel.Caption>
            <h3>Registration:</h3>
        ...
        <Carousel.Item>
          <Image src="/images/sign-in.png" fluid style={{ border: '5px solid black' }} />
          <Carousel.Caption>
            <h3>Sign-In:</h3>
        ...
        <Carousel.Item>
          <Image src="/images/edit-profile.png" fluid style={{ border: '5px solid black' }} />
          <Carousel.Caption>
            <h3>Edit Profile:</h3>
        ...
        <Carousel.Item>
          <Image src="/images/add-project.png" fluid style={{ border: '5px solid black' }} />
          <Carousel.Caption>
